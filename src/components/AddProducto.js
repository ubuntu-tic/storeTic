...
function AddProducto({
  ...
  const manejarSubmit = function (event) {
    ...
    console.log(accion);
    if (tipo != "editar") addFunction(datos);
    else updateFunction(datos);
  };
      ...
      <form className="addPRoducto" onSubmit={manejarSubmit}>
        ...
        <fieldset>
          <div className="form-group">
            <label htmlFor="urlImagen" className="form-label mt-3">
              Url Imagen
            </label>
            <input
              type="url"
          ...
          <div className="form-group">
            <label htmlFor="características" className="form-label mt-3">
          ...
          <div className="form-group">
            <label htmlFor="precio" className="form-label mt-3">
              Precio de Producto
            </label>
            <input
              type="number"
          ...
          <div className="form-group">
            <label htmlFor="stock" className="form-label mt-1">
              stock de Producto
            </label>
            <input
              type="number"
